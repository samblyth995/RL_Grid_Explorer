...
import numpy as np
from agent_Value import ValueNetwork
...
q_network = ValueNetwork(input_size=state_size, hidden_size=hidden_size, output_size=action_size)
target_network = ValueNetwork(input_size=state_size, hidden_size=hidden_size, output_size=action_size)
...
##write runs to csv
with open('training_runs_optim_VALUE_6_X_6.csv', mode='w', newline='') as file:
...
for episode in range(NUM_EPISODES):
    ...
    #     break
# print info to csv
    with open('training_runs_optim_VALUE_6_X_6.csv', mode='a', newline='') as file:
        writer = csv.writer(file)
        final_position= env.agent_position
